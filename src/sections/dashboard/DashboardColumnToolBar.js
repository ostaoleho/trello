...
DashboardColumnToolBar.propTypes = {
  columnName: PropTypes.string,
  onDelete: PropTypes.func,
  onUpdate: PropTypes.func,
};

DashboardColumnToolBar.dafalultProps = {
  onUpdate: () => {},
};

export default function DashboardColumnToolBar({ columnName, onDelete, onUpdate }) {
  const renameRef = useRef(null);

  const [value, setValue] = useState(columnName.name);
